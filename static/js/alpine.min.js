(() => {
  ...
  function mt(e) {
    ...
    for (let o = 0; o < e.length; o++) {
      if (
        ...
        (e[o].type === "childList" && (e[o].removedNodes.forEach((s) => {
  ...
  var Dn = {
    ...
    set({ objects: e }, t, r, n) {
      let i = e.find((s) => Object.prototype.hasOwnProperty.call(s, t)) ||
          e[e.length - 1],
...
`
    ...
    let r = Object.getPrototypeOf(async function () {}).constructor,
      ...
      o = (() => {
        try {
          ...
          return Object.defineProperty(s, "name", { value: `[Alpine] ${e}` }),
            s;
        } catch (s) {
  ...
  function Ne(e, t, r, n, i) {
    if (Me && typeof t == "function") {
      ...
      o instanceof Promise
        ...
        : e(o);
    } else {typeof t == "object" && t instanceof Promise
        ? t.then((o) => e(o))
        : e(t);}
  }
  var wt = "x-";
    ...
    return De[e] = t, {
      before(r) {
        if (!De[r]) {
          console.warn(
            String
              .raw`Cannot find directive \`${r}\`. \`${e}\` will use the default order of execution`,
          );
          return;
        }
        let n = G.indexOf(r);
  ...
  function pe(e, t, r) {
    ...
    let n = {};
    return t.map(dr((o, s) => n[o] = s)).filter(mr).map(zn(n, r)).sort(Kn).map(
      (o) => Bn(e, o),
    );
  }
  function Et(e) {
  ...
  function Bn(e, t) {
    let r = () => {}, n = De[t.type] || r, [i, o] = _t(e);
    Oe(e, t.original, o);
    let s = () => {
      e._x_ignore || e._x_ignoreSelf ||
  ...
  function gr() {
    ...
    E("Alpine has already been initialized on this page. Calling Alpine.start() more than once can cause problems."),
      _r = !0,
      document.body ||
      E("Unable to initialize. Trying to load Alpine before `<body>` is available. Did you forget to add `defer` in Alpine's `<script>` tag?"),
    ...
    Array.from(document.querySelectorAll(br().join(","))).filter(e).forEach(
      (t) => {
        S(t);
      },
    ),
  ...
  function Vn() {
    [["ui", "dialog", ["[x-dialog], [x-popover]"]], ["anchor", "anchor", [
      "[x-anchor]",
    ]], ["sort", "sort", ["[x-sort]"]]].forEach(([t, r, n]) => {
      lr(r) || n.some((i) => {
  ...
  function Ar(e, t) {
    let r = (o) => o.split(" ").filter(Boolean),
      n = (o) =>
        o.split(" ").filter((s) => !e.classList.contains(s)).filter(Boolean),
  ...
  window.Element.prototype._x_toggleAndCascadeWithTransitions = function (
    ...
    let i = document.visibilityState === "visible"
    ...
    e._x_hidePromise = e._x_transition
      ? new Promise((s, a) => {
        e._x_transition.out(() => {}, () => s(n)),
          e._x_transitioning && e._x_transitioning.beforeCancel(() =>
  ...
  function Fe(
    ...
    if (
      e._x_transitioning && e._x_transitioning.cancel(),
        Object.keys(r).length === 0 && Object.keys(n).length === 0 &&
  ...
  function Xn(e, t) {
    ...
    e._x_transitioning = {
      ...
      requestAnimationFrame(() => {
        if (r) return;
        let s = Number(
            getComputedStyle(e).transitionDuration.replace(/,.*/, "").replace(
              "s",
              "",
            ),
          ) * 1e3,
          a = Number(
            getComputedStyle(e).transitionDelay.replace(/,.*/, "").replace(
              "s",
              "",
            ),
          ) * 1e3;
        s === 0 &&
        (s = Number(getComputedStyle(e).animationDuration.replace("s", "")) *
          1e3),
          m(() => {
            t.before();
          }),
  ...
  function Qn(e, t) {
    if (Ot(e)) {
      ...
      Number.isInteger(t)
        ? e.value = t
        : !Array.isArray(t) && typeof t != "boolean" &&
  ...
  function ci(e) {
    return !["aria-pressed", "aria-checked", "aria-expanded", "aria-selected"]
      .includes(e);
  }
  function Lr(e, t, r) {
  ...
  function ze(e) {
    return e.type === "checkbox" || e.localName === "ui-checkbox" ||
  ...
  function zr(e, t) {
    ...
    Z[e] = t,
      Te(Z[e]),
      typeof t == "object" && t !== null && t.hasOwnProperty("init") &&
      typeof t.init == "function" && Z[e].init();
  }
  function Kr() {
    return Z;
  }
  ...
  var wi = Rt("__proto__,__v_isRef,__isVue"),
    an = new Set(
      Object.getOwnPropertyNames(Symbol).map((e) => Symbol[e]).filter(qe),
    ),
    Ei = cn();
  var vi = cn(!0);
  var Xr = Si();
  ...
  function Gi(e) {
    return [" ", "_"].includes(e)
      ? e
      : e.replace(/([a-z])([A-Z])/g, "$1-$2").replace(/[_\s]/, "-")
        .toLowerCase();
  }
  function Ji(e) {
  ...
  d(
    ...
    (e, { modifiers: t, expression: r }, { effect: n, cleanup: i }) => {
      ...
      var u = e.tagName.toLowerCase() === "select" ||
          ["checkbox", "radio"].includes(e.type) || t.includes("lazy")
        ? "change"
        : "input";
      let p = I ? () => {} : ae(e, u, t, (h) => {
        l(Kt(e, t, h, c()));
      ...
      if (
        t.includes("fill") &&
        ([void 0, null, ""].includes(c()) || ze(e) && Array.isArray(c()) ||
    ...
    return m(() => {
      ...
      if (ze(e)) {
        ...
        }
        {
          let i;
          return Ot(e)
            ? r.target.checked ? i = r.target.value : i = n
            : i = r.target.value,
            t.includes("number")
              ? Ht(i)
              : t.includes("boolean")
  ...
  function En(e) {
    return e !== null && typeof e == "object" && typeof e.get == "function" &&
      typeof e.set == "function";
  }
  d(
    "cloak",
    (e) => queueMicrotask(() => m(() => e.removeAttribute(C("cloak")))),
  );
  $e(() => `[${C("init")}]`);
  d(
    "init",
  ...
  function Sn(e, t, r, n) {
    let i = {};
    return /^\[.*\]$/.test(e.item) && Array.isArray(t)
      ? e.item.replace("[", "").replace("]", "").split(",").map((s) => s.trim())
        .forEach((s, a) => {
          i[s] = t[a];
        })
